...
window.isUndefined = function isUndefined$(o) {
    return (o === undefined);
};

window.isNull = function isNull$(o) {
    return (o === null);
};

window.isNullOrUndefined = function isNullOrUndefined$(o) {
...
window.Delegate = function Delegate$() {
}
...
window.CultureInfo = function CultureInfo$(name, numberFormat, dateFormat) {
    this.name = name;
...
window.IEnumerator = function IEnumerator$() { };
...
IEnumerable = function IEnumerable$() { };
...
window.ArrayEnumerator = function ArrayEnumerator$(array) {
    this._array = array;
    this._index = -1;
}
...
window.IDisposable = function IDisposable$() { };
...
window.IServiceProvider = function IServiceProvider$() { };
...
window.IServiceContainer = function IServiceContainer$() { };
...
window.StringBuilder = function StringBuilder$(s) {
...
window.EventArgs = function EventArgs$() {
}
...
window.XMLDocumentParser = function XMLDocumentParser$() {
}
...
window.ScriptLoader = function ScriptLoader$(scriptURLs) {
...
window.ScriptHost = function ScriptHost$ScriptHost$() {
}
ScriptHost.add_loaded = function ScriptHost$add_loaded(value) {
...
ScriptHost.remove_loaded = function ScriptHost$remove_loaded(value) {
    ScriptHost._loadedHandler = Delegate.remove(ScriptHost._loadedHandler, value);
}
ScriptHost.add_loading = function ScriptHost$add_loading(value) {
    ScriptHost._loadingHandler = Delegate.combine(ScriptHost._loadingHandler, value);
}
ScriptHost.remove_loading = function ScriptHost$remove_loading(value) {
...
ScriptHost.run = function ScriptHost$run(scriptletType, args) {
    if (ScriptHost._loaded) {
